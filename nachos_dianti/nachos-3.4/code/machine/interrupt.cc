...
/*int *tlb_visit_time = new int;
int *tlb_hit_time = new int; */
...
// lan4
    //printf("%d\n",tlb_visit_time);
    //int visit = tlb_visit_time;
    //int hit = tlb_hit_time;
    //double rate = hit/visit;
    //printf("TLB visit time: %d\nTLB hit time: %d\n",tlb_visit_time,tlb_hit_time);
