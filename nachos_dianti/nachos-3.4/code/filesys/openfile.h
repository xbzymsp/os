...
class OpenFile {
  public:
    ...
    int synch_Read(char *into, int numBytes);
		int synch_Write(char *from, int numBytes);
		int synch_Write2(char *from, int numBytes);
  //private:
    FileHeader *hdr;			// Header for this file 
    int seekPosition;			// Current position within the file
// lab5
		int _sector;  // file header's sector
