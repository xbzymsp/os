...
SynchDisk::SynchDisk(char* name)
{
    ...
    {
        rw_locks[i] = new Lock("rw_lock");
        locks[i] = new Lock("locks");
    }
}
...
{
    rw_locks[sector]->Acquire();
}

void
SynchDisk::rw_v(int sector)
{
    rw_locks[sector]->Release();
}

void 
SynchDisk::cnt_p(int sector)
{
    locks[sector]->Acquire();
}

void 
SynchDisk::cnt_v(int sector)
{
    locks[sector]->Release();
}
